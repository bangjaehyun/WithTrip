...
<body>
	...
	<main class="content mypage-container">
		<section class="section mypage-wrap">
			<div class="wrap">
				<div class="page-title">게시글 관리 페이지</div>
				<%--삭제 메소드. 삭제 서블릿으로 반환--%>
				<div style="height:5%">
					...
					<div style="border: 1px solid black; display: flex; width: 50%;" class="">
						<select>
							<option value="0">선택</option>
							<option value="srchId">Id로 검색</option>
							<option value="srchId">닉네임으로 검색</option>
						</select>
						<input>
				...
				<ul class="ntcPtc">
						...
						<li><a href="/admin/adminFrm?reqPage=1&NtcTp=4">4.파트너 작성글</a></li>
					</ul>
				</div>
					...
					<table class="tbl tbl-hover" style="border: 1px solid black">
						...
						<c:forEach var="ntc" items="${ntcList}">
							...
							<tr>
								...
								<%--게시물 제목--%>
								<td style="width: 60%;">${ntc.noticeTitle}</td>
								<%--작성일--%>
