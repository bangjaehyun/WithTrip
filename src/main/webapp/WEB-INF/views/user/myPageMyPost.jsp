...
<body>
	...
	<main class="content mypage-container">
		<div class="wrap">
			<div class="page-title">내가 작성한 여행일지</div>
			...
			<div class="main-body">
				<table class="tbl tbl-hover" style="border: 1px solid black">
					...
					<tr>
						...
						<th style="width: 60%; text-align: center;" colspan='2'>제목</th>
					...
					<c:forEach var="myPostList" items="${myPostList}">
						...
						<tr>
							<td style="width: 10%;" class="postId">${myPostList.postNo}</td>
							<td style="width: 60%;"><a href="/">${myPostList.postTitle}</a>
							</td>
							<td style="width: 10%;">${myPostList.postDate}</td>
							<td style="width: 10%;">
					...
					<tr>
						<td colspan="4">
							<button class="btn-primary sm" onclick="allSelDel()">선택 항목 삭제</button>
						</td>
					</tr>
				</table>
