...
/**
 * Servlet implementation class PostEditorFrmServlet
 */
@WebServlet("/post/editorWriteFrm")
public class PostEditorFrmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PostEditorFrmServlet() {
        super();
