...
//	}
	...
	public PostPageData selectPostReadList(String postTypeCd, int reqPage, String postTypeNm, String searchName) {
		Connection conn = JDBCTemplate.getConnection();
		...
		if(pageNo != 1) {
			//6,7,8,9,10 or 11,12,13,14,15 or 16,17,18,19,20 ................
			pageNavi += "<li>";
			pageNavi += "<a class = 'page-item' href='/post/orderSearch?reqPage=" + (pageNo - 1) + "&postTypeCd=" + postTypeCd + "&postTypeNm=" + postTypeNm+ "&searchName="+ searchName +"'>";
			pageNavi += "<span class='material-icons'>chevron_left</span></a>";
			pageNavi += "</li>";
		}
		...
		for( int i=0; i<pageNaviSize; i++) {
			...
			//선택한 페이지와, 선택하지 않은 페이지를 시각적으로 다르게 표현
			if(reqPage == pageNo) {
				pageNavi += "<a class='page-item active-page' href='/post/orderSearch?reqPage="+pageNo+"&postTypeCd="+postTypeCd+"&postTypeNm="+postTypeNm+ "&searchName="+ searchName +"'>";
			} else {
				pageNavi += "<a class='page-item' href='/post/orderSearch?reqPage="+pageNo+"&postTypeCd="+postTypeCd+"&postTypeNm="+postTypeNm+ "&searchName="+ searchName +"'>";
			}
			pageNavi += pageNo + "</a></li>";
			pageNo++;
	...
	public PostPageData selectPostlikeList(String postTypeCd, int reqPage, String postTypeNm, String searchName) {
		Connection conn = JDBCTemplate.getConnection();
	...
	public PostPageData selectPostLatestList(String postTypeCd, int reqPage, String postTypeNm, String searchName) {
Connection conn = JDBCTemplate.getConnection();
