...
public class CommonService {
	...
	public PageData Pagination(Pagination pgInfo) {
		 ...
		 */
			...
			if (pageNo != 1) {
				pageNavi += "<li>";
				pageNavi += "<a class='page-item' href='" + mapAddr + "?reqPage=" + (pageNo - 1) + "&postTypeId="
			...
			for (int i = 0; i < pageNavSize; i++) {
				...
				if (reqPage == pageNo) {
					pageNavi += "<a class='page-item active-page' href='" + mapAddr + "?reqPage=" + pageNo
							+ "&postTypeId=" + postTypeId + "&postTypeName=" + postTypeName + "&pageSize=" + pageSize
							+ "'>";
				} else {
					pageNavi += "<a class='page-item' href='" + mapAddr + "?reqPage=" + pageNo + "&postTypeId="
							+ postTypeId + "&postTypeName=" + postTypeName + "&pageSize=" + pageSize + "'>";
				}
			...
			if (pageNo <= totPage) {
				pageNavi += "<li>";
				pageNavi += "<a class='page-item' href='" + mapAddr + "?reqPage=" + pageNo + "&postTypeId=" + postTypeId
