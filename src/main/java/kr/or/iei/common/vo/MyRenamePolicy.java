...
public class MyRenamePolicy implements FileRenamePolicy{
	...
	public File rename(File originFile) {
		...
		int ranNum = new Random().nextInt(10000) + 1; // 1 ~ 10000까지 랜덤 숫자
		...
		SimpleDateFormat sdf = new SimpleDateFormat("yyyMMddHHmmssSSS");//20241029122734658
		
		String fileName = sdf.format(new Date(currentTime)) + str + ext;//20241029122734658 + _00060 + .txt
